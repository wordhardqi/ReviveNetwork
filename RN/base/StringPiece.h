...
#ifndef RN_STRINGPIECE_H
#define RN_STRINGPIECE_H
...
template<> struct __type_traits<RN::StringPiece>{
...
std::ostream &operator<<(std::ostream &o, const RN::StringPiece);
// Todo :: Need a implementation.

#endif //RN_STRINGPIECE_H
